/**
 * @file Customize material table row
  ...
  renderDetailPanelColumn() {
    ...
    if (typeof this.props.detailPanel == "function") {
      return (
        ...
        >
          <IconButton
          id="iconButton1RenderDetailPanelColumn"
            size={this.getElementSize()}
            style={{
        ...
        >
          ...
          >
            {this.props.detailPanel.map((panel, index) => {
              ...
              iconButton = (
                <IconButton
                id="iconButton2RenderDetailPanelColumn"
                  size={this.getElementSize()}
    ...
    if (this.props.isTreeData) {
      if (
        ...
        renderColumns.splice(
          0,
          0,
          <TableCell padding="none" key={"key-tree-data-column"}  id="key-tree-data-column"/>
        );
      }
    }
