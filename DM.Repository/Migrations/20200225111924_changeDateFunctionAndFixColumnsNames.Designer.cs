...
namespace DM.Repository.Migrations
{
    ...
    [Migration("20200225111924_changeDateFunctionAndFixColumnsNames")]
    partial class changeDateFunctionAndFixColumnsNames
    {
            ...
            modelBuilder.Entity("DM.Domain.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6386e1d9-3a44-4792-82cf-9eb4fdb66180",
                            Email = "admin@lit-co.net",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@LIT-CO.NET",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEOsFFtd3yDYmGNaiBi9O0hkFHJT3s4djW5z6EAUP44DTR/HfmtizYZPgiWbayIFtwA==",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4a298c21-0fc4-456b-a78c-831b19537f6d",
                            Email = "user@lit-co.net",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "USER@LIT-CO.NET",
                            NormalizedUserName = "USER",
                            PasswordHash = "AQAAAAEAACcQAAAAENd6T2TSLWdBjah/0v3DTe6Ga09c0eifwk0YLQ6GaL9SDGyleHxctRZPlJVisi8bLg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UserName = "user"
