/**
 * @file Customize material table toolbar
...
export class TableBodyToolbar extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderSearch() {
    const localization = {
      ...TableBodyToolbar.defaultProps.localization,
      ...this.props.localization,
    };
    if (this.props.search) {
      return (
        <TextField
        id="textFieldrRenderSearch"
          className={
          ...
          InputProps={{
            startAdornment: (
              <InputAdornment position="start">
                <Tooltip title={localization.searchTooltip} id="tooltipRenderSearch">
        ...
        {this.props.columnsButton && (
          <span>
            <Tooltip title={localization.showColumnsTitle}>
              <IconButton
              id="iconButton1RenderDefaultActions"
                color="inherit"
                onClick={(event) =>
            ...
            >
              ...
              {this.props.columns.map((col) => {
                return (
                  <MenuItem
                  id={"columnsRenderDefaultActions"+col.id}
        ...
        {this.props.exportButton && (
          <span>
            <Tooltip title={localization.exportTitle}>
              <IconButton
              id="iconButton2RenderDefaultActions"
                color="inherit"
                onClick={(event) =>
            ...
            <Menu
            id="menu2RenderDefaultActions"
              anchorEl={this.state.exportButtonAnchorEl}
              open={Boolean(this.state.exportButtonAnchorEl)}
              onClose={() => this.setState({ exportButtonAnchorEl: null })}
            >
              <MenuItem key="export-csv" onClick={this.exportCsv} id="exportCsvMenuItem">
...
export default withStyles(styles)(TableBodyToolbar);
